...
router.post('/chaos-explain', authMiddleware, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    ...
    const response = await callAI(
      prompt,
      'You are a systems reliability engineer explaining a live incident. Be specific, concise, educational.',
      1000,
      customGroqKey,
      customGeminiKey
    );
